    ...
    async def scrape_rates(self, silent: bool = False) -> Dict:
        ...
        try:
            async with self:
                ...
                # Calcular min, avg, max para SELL
                ...
                # Promedio general (usando los promedios)
                ...
                return {
                    ...
                    'data': {
                        ...
                        # Valores principales (para compatibilidad)
                        'sell_rate': sell_avg,
                        'buy_rate': buy_avg,
                        # Nuevos valores: min, avg, max para SELL
                        'sell_min': sell_min,
                        'sell_avg': sell_avg,
                        'sell_max': sell_max,
                        # Nuevos valores: min, avg, max para BUY
                        'buy_min': buy_min,
                        'buy_avg': buy_avg,
                        'buy_max': buy_max,
                        # Spreads
                        ...
                        # Compatibilidad con spread anterior
