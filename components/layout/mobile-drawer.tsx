      ...
      {open && (
        ...
        >
          ...
          <motion.aside
            ...
            className="glass-card relative flex h-full w-[min(20rem,calc(100vw-1rem))] flex-col border-l-0 border-border pb-safe-bottom pl-safe-left pt-safe-top shadow-ios-lg"
          >
