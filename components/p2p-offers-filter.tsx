        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center">
          ...
          >
            <button
              ...
              className={`flex min-h-[44px] items-center justify-center gap-2 rounded-lg px-3 text-sm font-semibold transition-colors focus-ring ${
                isBuy
              ...
              <li key={offer.id}>
                <Card className="flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:gap-6 sm:p-5">
                  ...
                  <BinanceMarketLink
                    ...
                    className={`flex min-h-[44px] w-full shrink-0 items-center justify-center gap-2 rounded-xl px-5 text-sm font-bold text-white transition-colors focus-ring sm:w-auto ${
                      isBuy
