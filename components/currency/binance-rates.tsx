...
export const BinanceRatesComponent = React.memo(
  function BinanceRatesComponent() {
    ...
    useEffect(() => {
      ...
      // Auto-refresh every 2 minutes for P2P data (only while visible)
      const interval = window.setInterval(fetchWhenVisible, 120000);
        ...
        >
          <div className="py-2 text-center sm:py-4">
            ...
            <p className="mb-2 text-3xl font-bold text-primary sm:mb-3 sm:text-5xl">
              Bs. {marketSummary?.average.toFixed(2) || '0.00'}
            </p>
