    ...
    <div ref={containerRef} className="relative inline-block text-left">
      ...
      {isOpen && !isMobile && (
        <div
          ...
          className="animate-in fade-in zoom-in-95 absolute right-0 top-full z-50 mt-2 w-72 origin-top-right rounded-2xl border border-border/50 bg-card/95 p-1.5 shadow-2xl backdrop-blur-xl duration-150 focus:outline-none"
        >
          ...
          <div className="space-y-1 py-1">
            <button
              ...
              className="group flex w-full items-start gap-3 rounded-xl p-2.5 text-left transition-colors hover:bg-primary/10 focus:bg-primary/10 focus:outline-none"
            >
            ...
            <button
              ...
              className="group flex w-full items-start gap-3 rounded-xl p-2.5 text-left transition-colors hover:bg-indigo-500/10 focus:bg-indigo-500/10 focus:outline-none"
            >
        ...
        createPortal(
          ...
          >
            ...
            <div
              ...
              id={menuId}
              role="menu"
              className="animate-in slide-in-from-bottom duration-250 relative z-10 w-full rounded-t-3xl border-t border-border/40 bg-card/95 p-5 shadow-2xl backdrop-blur-2xl ease-out"
              style={{
              ...
              <div className="space-y-2.5">
                ...
                >
                  ...
                  <div className="flex min-w-0 flex-1 flex-col">
                    ...
                    <span className="mt-0.5 text-xs text-muted-foreground">
                      Crea un gasto, ingreso o transferencia con el formulario
                      completo.
                    </span>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="flex min-w-0 flex-1 flex-col">
                    ...
                    <span className="mt-0.5 text-xs text-muted-foreground">
                      Sube fotos o capturas de pantalla de pagos y extrae los
