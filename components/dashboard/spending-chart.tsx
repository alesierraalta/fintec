...
import { ExpensesByCategoryChart } from '@/lib/recharts';
...
function SpendingChartComponent() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Chart Container - Using unified Recharts library */}
...
export const SpendingChart = memo(SpendingChartComponent);'use client';
