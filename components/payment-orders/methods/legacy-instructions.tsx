...
interface LegacyInstructionsProps {
  order: PaymentOrder;
}
...
export function LegacyInstructions({ order }: LegacyInstructionsProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border-2 border-primary/20 bg-primary/5 p-6">
        ...
        <div className="flex items-center gap-2 rounded-lg bg-background p-3">
          <code className="flex-1 font-mono text-sm font-semibold">{paymentReference}</code>
          <button
