...
- [x] 2.0 Integrate View Mode in Categories Page
...
- [ ] 3.0 Mobile UX & Design Refinement
  - [x] 3.1 Check touch targets in "List" mode. Ensure the "Edit" and "Delete" buttons (or the card click area) are at least 44x44px or have sufficient padding.
  - [x] 3.2 Verify visual consistency: The list items should share the same "glassmorphism" aesthetic (`bg-card/90`, `backdrop-blur`) as the rest of the app.
  - [x] 3.3 Test text truncation: Ensure long category names do not break the "List" row layout on small screens.
