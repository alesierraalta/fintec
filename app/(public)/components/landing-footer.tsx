...
/**
 * Social icon SVG components (inline to avoid extra dependencies).
 */
...
/**
 * Expanded landing footer with navigation columns and social links.
 */
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1">
            <FinTecLogo
              containerClassName="h-12 w-24 sm:h-16 sm:w-32"
              sizes="(max-width: 768px) 96px, 128px"
              fallbackClassName="text-xl"
            />
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              La app de finanzas personales más completa para Venezuela. Tasas
              actualizadas, gestión inteligente.
            </p>
          </div>
