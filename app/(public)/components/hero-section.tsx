      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto mb-14 max-w-4xl text-center">
          ...
          <p className="mx-auto mb-9 max-w-2xl text-lg leading-relaxed text-muted-foreground sm:text-xl">
            Organiza tus cuentas, movimientos y presupuestos para tomar mejores
            decisiones financieras en Venezuela.
          </p>
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            <TrackedLandingLink
              ...
              className="group inline-flex min-h-[48px] w-full items-center justify-center gap-2 rounded-xl bg-primary-700 px-7 py-3.5 text-base font-semibold text-white shadow-lg shadow-primary-700/20 transition-all hover:-translate-y-0.5 hover:bg-primary-800 sm:w-auto"
            >
            ...
            <TrackedLandingLink
              href="#tasas-en-vivo"
              eventName="rate_cockpit_interaction"
        ...
        <div className="relative mx-auto max-w-5xl">
          <p className="sr-only">
            Vista demostrativa de FinTec: un movimiento se convierte en
            presupuesto y ayuda a tomar una decisión.
          </p>
          ...
          >
            ...
            <div className="grid gap-6 p-5 sm:p-7 lg:grid-cols-[1.35fr_0.65fr] lg:p-9">
              ...
              <div className="relative flex min-h-64 flex-col justify-center rounded-2xl border border-primary/15 bg-gradient-to-b from-primary/[0.08] to-transparent p-5 sm:p-6">
                <div className="pointer-events-none absolute inset-x-6 top-1/2 h-px bg-gradient-to-r from-primary/10 via-primary to-cyan-400/10 motion-safe:animate-pulse" />
                <div className="relative space-y-4">
                  <Node label="Movimiento" detail="Registra lo que pasó" />
                  <Node label="Presupuesto" detail="Entiende tu margen" />
                  <Node label="Decisión" detail="Actúa con claridad" />
                </div>
              </div>
            </div>
          </div>
          <p className="mt-4 text-center text-xs text-muted-foreground">
            Las tasas se consultan en un solo cockpit cuando las necesites ·{' '}
            <a href="#tasas-en-vivo" className="font-medium text-primary">
...
function Node({ label, detail }: { label: string; detail: string }) {
  return (
    <div className="relative flex items-center gap-3 rounded-xl border border-border/50 bg-card/80 p-3">
      <span className="h-3 w-3 shrink-0 rounded-full bg-primary shadow-[0_0_0_5px_hsl(var(--primary)/.12)]" />
      <div>
