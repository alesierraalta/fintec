        ...
        <PageHeader
          ...
          actions={
            <BinanceMarketLink
              ...
              className="focus-ring inline-flex min-h-[44px] items-center gap-2 rounded-xl border border-border/60 bg-card px-4 text-sm font-medium text-foreground transition-colors hover:bg-muted/40"
            >
              Ir a Binance
